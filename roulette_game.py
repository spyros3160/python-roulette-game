...
def update_history():
    ...
    # Παίρνουμε τα τελευταία 10 αποτελέσματα από το ιστορικό (αντιστραμμένα)
    for result in reversed(history[-15:]): #Διατρέχει από τη λίστα history τα τελευταία 10 αποτελέσματα από το πιο πρόσφατο στο πιο παλιό
